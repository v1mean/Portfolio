const TIMELINE = [
  ...
  },
  {
    ...
    type: 'work',
    icon: '💼',
    desc: 'Built and maintained a Vue.js frontend application integrated with Firebase backend. Worked with the team on agile sprint cycles, code reviews, and real-world deployment workflows.',
    tags: ['Vue.js', 'Firebase', 'JavaScript', 'Agile'],
    status: 'Completed',
  },
  {
    year: '2024',
        ...
        <div className="container">
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(240px, 1fr))', gap: '1.25rem', maxWidth: 800, margin: '0 auto 3rem' }}>
            {CERTIFICATIONS.map((cert, i) => (
              <div key={i} className="timeline-card" style={{ display: 'flex', gap: '1rem', alignItems: 'flex-start' }}>
