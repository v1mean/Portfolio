          ...
          <div className="about-grid">
            ...
            <div className="about-avatar-wrapper">
              ...
              <div className="about-quick-links">
                ...
                <a href={`mailto:${PERSONAL.email}`} className="btn btn-outline btn-sm" id="about-email-btn">
                  📧 Email
                </a>
                <a href="/resume.pdf" download="NgornVimean_Resume.pdf" className="btn btn-primary btn-sm" id="about-resume-btn">
                  📄 Résumé
                </a>
              </div>
            ...
            <div>
              ...
              <div style={{ background: 'var(--bg-card)', border: '1px solid var(--border)', borderRadius: 'var(--radius-lg)', padding: '1.25rem', marginBottom: '2rem' }}>
                ...
                <div style={{ display: 'flex', flexWrap: 'wrap', gap: '0.5rem' }}>
                  {FUN_FACTS.map((fact, i) => (
                    <span key={i} className="skill-tag" style={{ borderRadius: 'var(--radius-md)', padding: '0.4rem 0.75rem' }}>
                      {fact}
                    </span>
                  ))}
                </div>
              ...
              <div>
                ...
                <div className="services-grid">
                  {SERVICES.map((s, i) => (
                    <div className="service-card" key={i} id={`service-${s.title.toLowerCase().replace(/\s/g, '-')}`}>
              ...
              <div className="resume-banner">
                ...
                <div style={{ display: 'flex', gap: '0.75rem', flexWrap: 'wrap' }}>
                  <a href="/resume.pdf" download="NgornVimean_Resume.pdf" className="btn btn-primary" id="about-download-resume-btn">
                    📄 Download Résumé
                  </a>
                  <a href="/#contact" className="btn btn-outline" id="about-contact-btn">
                    Get in Touch
                  </a>
                </div>
              </div>
