      ...
      <div className="container" style={{ paddingTop: '2rem', paddingBottom: '4rem' }}>
        ...
        {filtered.length > 0 ? (
          <div className="blog-grid">
            {filtered.map((post) => (
              <article key={post.id} className="blog-card" id={`blog-post-${post.id}`}>
                ...
                <div className="blog-card-body">
                  ...
                  <div className="blog-card-footer">
                    ...
                    <button
                      ...
                      onClick={() => alert('Full blog posts coming soon! 🚀')}
        ...
        <div className="resume-banner" style={{ marginTop: '3rem' }}>
          ...
          <a href="/#contact" className="btn btn-primary" id="blog-contact-btn">
            Get Notified
          </a>
        </div>
      </div>
